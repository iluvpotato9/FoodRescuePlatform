<?php $__env->startSection('title', 'Login - Food Rescue Platform'); ?>
...
<div class="auth-shell">
    <section class="auth-panel">
        <div class="auth-form">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" style="margin-top: 30px">
                <?php echo csrf_field(); ?>
            ...
            <p class="muted small" style="margin-top: 22px; text-align: center">
                New to FoodBridge? <a href="<?php echo e(route('register')); ?>"><strong>Create an account</strong></a>
            </p>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\alzw7\Downloads\FoodRescuePlatformClean (2)\FoodRescuePlatformClean\resources\views/auth/login.blade.php ENDPATH**/ ?>