...
@section('title', 'Register - Food Rescue Platform')
    ...
    <section class="auth-panel">
        <div class="auth-form" style="max-width: 580px">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="role" name="role" required>
                            ...
                            <option value="donor" @selected(old('role') === 'donor')>Food donor</option>
                            <option value="driver" @selected(old('role') === 'driver')>Volunteer driver</option>
                        </select>
                    </div>
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="number" id="household_size" name="household_size"
                                       value="{{ old('household_size', 1) }}" min="1" max="30">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group full">
                                ...
                                <textarea id="dietary_needs" name="dietary_needs" maxlength="500">{{ old('dietary_needs') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group full">
            ...
            <p class="muted small" style="margin-top: 22px; text-align: center">
                Already registered? <a href="{{ route('login') }}"><strong>Sign in</strong></a>
            </p>
        </div>
    </section>
